    ...
    return (
        <section className='HowToBuyPage wrapper'>
            ...
            <div className='HowToBuyPage__item'>
                ...
                <p className='HowToBuyPage__itemDescription'>После регистрации вы сможете совершать заказы и отслеживать
                    их
            ...
            <div className='HowToBuyPage__item'>
                ...
                <p className='HowToBuyPage__itemDescription'>Воспользуйтесь поиском: укажите название лекарства, бренда
                    или
            ...
            <div className='HowToBuyPage__item'>
                ...
                <p className='HowToBuyPage__itemDescription'>Нажмите на значок "Корзины" на карточке товара и добавьте
                    нужное
                    количество.
            ...
            <div className='HowToBuyPage__item'>
                ...
                <p className='HowToBuyPage__itemDescription'>Выберите из предложенного списка аптеку, где планируете
                    забрать
                    заказ.</p>
            </div>
            ...
            <div className='HowToBuyPage__item'>
                ...
                <p className='HowToBuyPage__itemDescription'>
                    Проверьте номер телефона и email, на email придёт сообщение со статусом заказа, а на телефон может
                    позвонить
            ...
            <div className='HowToBuyPage__item'>
                ...
                <p className='HowToBuyPage__itemDescription'>
                    По Email мы сообщим, когда можно прийти в аптеку за заказом. В аптеке назовите номер телефона или
                    номер
                    заказа, оплатите и заберите заказ. Не забудьте взять с собой рецепт, если в заказе есть рецептурный
                    препарат.
                </p>
            </div>
        </section>
