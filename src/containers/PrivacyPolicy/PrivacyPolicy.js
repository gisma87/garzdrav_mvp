      ...
      <div className='PrivacyPolicy__content'>
        <ol>
          <li>
            ...
            <div>
              <p>
                ...
                и
                меры по обеспечению безопасности персональных данных ООО «Аптечная сеть «Гармония здоровья» (далее –
                Оператор).
              </p>
              <p>
              ...
              <p>
                2. Настоящая политика Оператора в отношении обработки персональных данных (далее – Политика) применяется
          ...
          <li>
            ...
            <div>
              ...
              <p>
                ...
                данных,
                обеспечивающих их доступность в сети интернет по сетевому адресу http://garzdrav.ru/;
              </p>
              <p>
              ...
              <p>
                ...
                определяемому Пользователю веб-сайта http://garzdrav.ru/;
              </p>
              <p>
                9. Пользователь – любой посетитель веб-сайта http://garzdrav.ru/;
              </p>
              <p>
              ...
              <p>
                12. Уничтожение персональных данных – любые действия, в результате которых персональные данные
          ...
          <li>
            ...
            <p>
              10. Также на сайте происходит сбор и обработка обезличенных данных о посетителях (в т.ч. файлов «cookie»)
          ...
          <li>
            ...
            <p>
              1. Цель обработки персональных данных Пользователя — предоставление обратной связи пользователю, ответа на
            ...
            <p>
              ...
              сообщений, направив Оператору письмо на адрес электронной почты info@garzdrav.ru с пометкой «Отказ от
          ...
          <li>
            ...
            <p>
              ...
              Пользователем самостоятельно через специальные формы, расположенные на сайте http://garzdrav.ru/. Заполняя
          ...
          <li>
            ...
            <p>
              1. Оператор обеспечивает сохранность персональных данных и принимает все возможные меры, исключающие
              доступ
            ...
            <p>
              ...
              почты
              на электронный адрес Оператора info@garzdrav.ru с пометкой «Отзыв согласия на обработку персональных
              данных».
            </p>
          </li>
          <li>
            ...
            <p>
              ...
              http://garzdrav.ru/politika-konfidentsialnosti/.
            </p>
          </li>
        </ol>
      </div>
